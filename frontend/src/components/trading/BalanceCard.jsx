            ...
            <div className="relative space-y-3">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="h-10 flex-1 border-primary/50 bg-gradient-to-r from-primary/20 to-primary/10 text-foreground hover:from-primary/30 hover:to-primary/20"
                  variant="outline"
                >
                ...
                <Button
                  onClick={() => onMintToken()}
                  disabled={mintingLoading || !partyId || !onMintToken}
                  className="h-10 px-4 border-primary/50 bg-gradient-to-r from-primary/30 to-primary/20 text-foreground hover:from-primary/40 hover:to-primary/30 shrink-0"
                  variant="outline"
                  title="Mint all default test tokens"
                >
                  Mint All
                </Button>
              </div>
