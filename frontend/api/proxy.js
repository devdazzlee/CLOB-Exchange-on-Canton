...
export default async function handler(req, res) {
  ...
  try {
    ...
    // SOLUTION: Always use static token (Keycloak not adding actAs/readAs claims)
    ...
    // Always use static token (Keycloak not adding required claims)
    let cantonToken = `Bearer ${staticToken}`;
    
    console.log('[Proxy] Using static token (Keycloak missing actAs/readAs claims)');
