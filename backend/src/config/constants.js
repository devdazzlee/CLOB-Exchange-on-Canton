...
// Discovered from user's active contracts on devnet
 ...
 */
const TOKEN_STANDARD_PACKAGE_ID = process.env.TOKEN_STANDARD_PACKAGE_ID || '5f41fdb377a25ceddc872dfdb6cd6b7dc02c35b0b536ba4253f6608cea4336f5';
...
const TEMPLATE_IDS = {
  ...
  // Symbol: CC (Canton Coin) - shown as "Amulet" in wallet
  ...
  // Custom Token Standard Templates (with Archive choices)
