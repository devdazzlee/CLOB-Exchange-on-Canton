 ...
 * - Keycloak: OAuth realm for canton-devnet
 */
...
const config = {
  ...
  canton: {
    ...
    // Executor OAuth configuration (CARDIV TOKEN)
    executorOauth: {
      clientId: process.env.EXECUTOR_CLIENT_ID,
      clientSecret: process.env.EXECUTOR_CLIENT_SECRET,
    },
